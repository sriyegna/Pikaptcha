    ...
    if rv!= 'OK':
        ...
        for num in data[0].split():
            if (time.clock() - start_time) > 30:
                print("It has been " + string(time.clock() - start_time) + " seconds. Please use an email address with an empty inbox.")
            ...
            if subjmsg.find("Trainer Club Activation") != -1:
                ...
                if validkey_index != -1:
                    ...
                    try:
                        ...
                        while(validate_response == "Failed"):
                            validate_response = urlopen(validlink)
